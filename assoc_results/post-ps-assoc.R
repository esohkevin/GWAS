...
psassoc1=read.table("ps-qc-camgwasC1C5C9.assoc.logistic", header = T, as.is = T)
...
png(filename = "psC145-assoc-add.png", width = 750, height = 450, units = "px", pointsize = 12,
    bg = "white",  res = NA)
par(mfrow=c(1,1))
...
psassoc2=read.table("ps-qc-camgwasC1-C10-add.assoc.logistic", header = T, as.is = T)
...
png(filename = "psC1-10-assoc-add.png", width = 750, height = 450, units = "px", pointsize = 12,
    bg = "white",  res = NA)
par(mfrow=c(1,1))
...
psassoc3=read.table("ps-qc-camgwasC1-C10-hethom.assoc.logistic", header = T, as.is = T)
...
png(filename = "psC1-10-assoc-hethom.png", width = 750, height = 450, units = "px", pointsize = 12, bg = "white",  res = NA)
par(mfrow=c(1,1))
...
# Using all PCs
psassoc4=read.table("ps-qc-camgwasC1-C10-rec.assoc.logistic", header = T, as.is = T)
...
png(filename = "psC1-10-assoc-rec.png", width = 750, height = 450, units = "px", pointsize = 12,
    bg = "white",  res = NA)
par(mfrow=c(1,1))
...
# Using all PCs
psassoc5=read.table("ps-qc-camgwasC1-C10-dom.assoc.logistic", header = T, as.is = T)
...
png(filename = "psC1-10-assoc-dom.png", width = 750, height = 450, units = "px", pointsize = 12,
    bg = "white",  res = NA)
par(mfrow=c(1,1))
...
png(filename = "ps-qq_plots.png", width = 700, height = 500, units = "px", pointsize = 12,
    bg = "white",  res = NA)
par(mfrow=c(2,2))
