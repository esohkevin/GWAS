...
###################### Using PC1 and PC2 ##############################
imassoc=read.table("shapeit-post-impc1c2.assoc.logistic", header = T, as.is = T)
...
imassoc1=read.table("shapeit-post-impc1c5c9.assoc.logistic", header = T, as.is = T)
...
############################# Using All PCs ######################################
imassoc2=read.table("shapeit-post-impc1-c10.assoc.logistic", header = T, as.is = T)
...
#imassoc3=read.table("shapeit-post-impc1-c10-model-updated.model", header = T, as.is = T)
...
imassoc4=read.table("shapeit-post-impc1-c10-hethom-noNA.assoc.logistic", header = T, as.is = T)
