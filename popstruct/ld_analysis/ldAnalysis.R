...
png(args[7], height=580, width=600, units="px")
par(mfrow=c(4,2))

par(fig=c(0, 0.5, 0.535, 1), bty="o", cex.main=0.8, cex.axis=0.7)
plot(hHbC11$BP_B, hHbC11$R2, pch=20, xlim=c(135133000,137113000), xlab=" ", ylab="LD (r^2)", main="CAM", col = hHbC11$Col)
abline(h=0.5,lty=2, col="grey")

par(fig=c(0.5, 1, 0.535, 1),new=T, bty="o", cex.main=0.8, cex.axis=0.7)
plot(hHbC11yri$BP_B, hHbC11yri$R2, pch=20, xlim=c(135133000,137113000), xlab=" ", ylab="LD (r^2)", main="YRI", col = hHbC11yri$Col)
abline(h=0.5, lty=2, col="grey")

par(fig=c(0.5,1, 0.15, 0.605),new=T, bty="o", cex.main=0.8, cex.axis=0.7)
plot(hHbC11gwd$BP_B, hHbC11gwd$R2, pch=20, xlim=c(135133000,137113000), xlab=" ", ylab="LD (r^2)", main="GWD", col = hHbC11gwd$Col)
abline(h=0.5, lty=2, col="grey")

#plot(hHbC11gbr$BP_B, hHbC11gbr$R2, pch=20, xlim=c(135133000,137113000), xlab=" ", ylab="LD (r^2)", main="GBR", col = hHbC11gbr$Col)
#abline(h=0.5, lty=2, col="grey")

par(fig=c(0,0.5, 0.15, 0.605),new=T, bty="o", cex.main=0.8, cex.axis=0.7)
plot(hHbC11lwk$BP_B, hHbC11lwk$R2, pch=20, xlim=c(135133000,137113000), xlab=" ", ylab="LD (r^2)", main="LWK", col = hHbC11lwk$Col)
abline(h=0.5, lty=2, col="grey")

#plot(hHbC11chb$BP_B, hHbC11chb$R2, pch=20, xlim=c(135133000,137113000), xlab=" ", ylab="LD (r^2)", main="CHB", col = hHbC11chb$Col)
#abline(h=0.5, lty=2, col="grey")

par(fig=c(0, 0.5, 0, 0.25), new=TRUE, bty="n", cex.axis=1)
plot(recomRange$position, recomRange$COMBINED_rate.cM.Mb., xlim=c(135133000,137113000), xlab="BP", ylab="cM/Mb", type="l")
