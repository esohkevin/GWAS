...
png("WorldPCA.png", height=740, width=650, units="px", points=14, res=NA)
...
if(evecDat[i,12]=='SB') points(evecDat[i,2], evecDat[i,3], col="deeppink", pch=15)
if(evecDat[i,12]=='FO') points(evecDat[i,2], evecDat[i,3], col="deeppink", pch=15)
if(evecDat[i,12]=='ACB') points(evecDat[i,2], evecDat[i,3], col="deeppink4", pch=15)
if(evecDat[i,12]=='ASW') points(evecDat[i,2], evecDat[i,3], col="deeppink4", pch=15)
if(evecDat[i,12]=='ESN') points(evecDat[i,2], evecDat[i,3], col="deeppink2", pch=15)
if(evecDat[i,12]=='YRI') points(evecDat[i,2], evecDat[i,3], col="deeppink2", pch=15)
if(evecDat[i,12]=='MSL') points(evecDat[i,2], evecDat[i,3], col="deeppink3", pch=15)
if(evecDat[i,12]=='GWD') points(evecDat[i,2], evecDat[i,3], col="deeppink3", pch=15)
if(evecDat[i,12]=='LWK') points(evecDat[i,2], evecDat[i,3], col="deeppink1", pch=15)
if(evecDat[i,12]=='CLM') points(evecDat[i,2], evecDat[i,3], col="aquamarine", pch=16)
if(evecDat[i,12]=='MXL') points(evecDat[i,2], evecDat[i,3], col="aquamarine1", pch=16)
if(evecDat[i,12]=='PEL') points(evecDat[i,2], evecDat[i,3], col="aquamarine2", pch=16)
if(evecDat[i,12]=='PUR') points(evecDat[i,2], evecDat[i,3], col="aquamarine3", pch=16)
if(evecDat[i,12]=='CEU') points(evecDat[i,2], evecDat[i,3], col="chartreuse", pch=17)
if(evecDat[i,12]=='FIN') points(evecDat[i,2], evecDat[i,3], col="chartreuse1", pch=17)
if(evecDat[i,12]=='GBR') points(evecDat[i,2], evecDat[i,3], col="chartreuse2", pch=17)
if(evecDat[i,12]=='IBS') points(evecDat[i,2], evecDat[i,3], col="chartreuse3", pch=17)
if(evecDat[i,12]=='TSI') points(evecDat[i,2], evecDat[i,3], col="chartreuse4", pch=17)
if(evecDat[i,12]=='BEB') points(evecDat[i,2], evecDat[i,3], col="deepskyblue", pch=18)
if(evecDat[i,12]=='GIH') points(evecDat[i,2], evecDat[i,3], col="deepskyblue1", pch=18)
if(evecDat[i,12]=='ITU') points(evecDat[i,2], evecDat[i,3], col="deepskyblue2", pch=18)
if(evecDat[i,12]=='PJL') points(evecDat[i,2], evecDat[i,3], col="deepskyblue3", pch=18)
if(evecDat[i,12]=='STU') points(evecDat[i,2], evecDat[i,3], col="deepskyblue4", pch=18)
if(evecDat[i,12]=='CDX') points(evecDat[i,2], evecDat[i,3], col="goldenrod", pch=20)
if(evecDat[i,12]=='CHB') points(evecDat[i,2], evecDat[i,3], col="goldenrod1", pch=20)
if(evecDat[i,12]=='CHS') points(evecDat[i,2], evecDat[i,3], col="goldenrod2", pch=20)
if(evecDat[i,12]=='JPT') points(evecDat[i,2], evecDat[i,3], col="goldenrod3", pch=20)
if(evecDat[i,12]=='KHV') points(evecDat[i,2], evecDat[i,3], col="goldenrod4", pch=20)
}
