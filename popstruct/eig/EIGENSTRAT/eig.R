...
png("evec1v2.png", res=1200, height=5, width=4, units="in")
par(mfrow=c(2,1), cex=0.5, mai=c(0.4,0.6,0.5,0.6))
...
plot(mergedEvecDat$PC1, mergedEvecDat$PC2, col=mergedEvecDat$PopGroup, main="Eigenanalysis With Sample Region", xlab="eignvalue1", ylab="eigenvalue2", pch=20)
...
png("eigenv1-v10.png", res=1200, height=4, width=6, units="in")
par(mfrow=c(2,3), cex=0.4, cex.lab=0.8, cex.axis=0.8, cex.main=0.8)
