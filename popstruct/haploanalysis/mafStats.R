...
hist(frq$MAF[frq$CLST=="MSL"], xlim=c(0,0.50),breaks=300, col=6, labels =F, add=T)    
hist(frq$MAF[frq$CLST=="CAM"], xlim=c(0,0.50),breaks=300, col=7, labels =F, add=T)     
legend("topright", c("GWD", "LWK","YRI","ESN","MSL","CAM"), pch=16, col = c(2,3,4,5,6,7), horiz=F, bty="n")
dev.off()
