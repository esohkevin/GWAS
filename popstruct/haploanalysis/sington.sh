...
grep -wv -f lwkSington.id.txt tmp2.txt > yriOnlySington.id.txt

# GWD-only singletons
grep -wv -f yriSington.id.txt gwdSington.id.txt > tmp1.txt
grep -wv -f mslSington.id.txt tmp1.txt > tmp2.txt
grep -wv -f lwkSington.id.txt tmp2.txt > gwdOnlySington.id.txt

# MSL-only singletons
grep -wv -f gwdSington.id.txt mslSington.id.txt > tmp1.txt
grep -wv -f yriSington.id.txt tmp1.txt > tmp2.txt
grep -wv -f lwkSington.id.txt tmp2.txt > mslOnlySington.id.txt

# LWK-only singletons
grep -wv -f gwdSington.id.txt lwkSington.id.txt > tmp1.txt
grep -wv -f mslSington.id.txt tmp1.txt > tmp2.txt
grep -wv -f yriSington.id.txt tmp2.txt > lwkOnlySington.id.txt
