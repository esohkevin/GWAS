...
#png(args[3], height = 700, width = 640, res = NA, units = "px")
#layout(matrix(1:2,2,1))
#ihsplot(wg.ihs, plot.pval = TRUE, ylim.scan = 4, main = args[4])
#dev.off()

# Gaussian Distribution and Q-Q plots
png("qqPlot.png", height = 700, width = 440, res = NA, units = "px", type = "cairo")
layout(matrix(1:2,2,1))
distribplot(wg.ihs$iHS[,3], xlab="iHS")
dev.off()

# Bifurcation plot
#png("bifurcation1.png", height = 700, width = 640, res = NA, units = "px", type = "cairo")
#layout(matrix(1:2,2,1))
