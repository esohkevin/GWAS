...
for i in sm sma clean; do /mnt/lustre/groups/CBBI1243/KEVIN/bioTools/plink2 --bfile sbba --glm omit-ref sex hide-covar --covar sb_ba.pca.glm.cov --covar-name C1 C3 C4 C5 --ci 0.95 --out ${i} --keep ${i}.cov --adjust; done
